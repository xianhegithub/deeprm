...
class Parameters:
    def __init__(self):
        ...
        self.num_steps_in_epi = 10             # old:simu_len length of the busy cycle that repeats itself
        self.num_epis = 1                # old: num_ex number of episodes

        self.output_freq = 10        # interval for output and store parameters

        self.num_epis_per_batch = 10    # number of episodes to compute baseline
